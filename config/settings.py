"""
Django settings for config project — compatible con desarrollo local y Render.

Desarrollo local → DEBUG=True, SQLite, sin DATABASE_URL.
Producción (Render) → DEBUG=False, PostgreSQL vía DATABASE_URL, WhiteNoise estático.
"""
...
# ALLOWED_HOSTS: en desarrollo acepta localhost; en Render se pasa el dominio .onrender.com
...
# Base de datos:
# - Producción (Render): usa DATABASE_URL provista por el servicio PostgreSQL de Render.
